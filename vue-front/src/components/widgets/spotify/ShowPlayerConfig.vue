<template>
  <widget-creation-dialog
    ...
    description="This widget allows you to play a show from Spotify."
    @done="$emit('done', name, { name: uri })"
    :button-text="buttonText"
    :validator="validator"
  >
    <v-text-field label="Show URI" v-model="uri" />
  </widget-creation-dialog>
</template>
...
export default class ShowPlayerConfig extends Vue {
  readonly name: WidgetName = 'spotify_podcast'
